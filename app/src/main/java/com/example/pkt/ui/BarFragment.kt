...
import com.example.pkt.databinding.FragmentBarBinding
...
class BarFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sharedViewModel.totalValue.observe(viewLifecycleOwner) { price ->
            binding.totalTextView.text = "Suma: ${price}zł"
        }
