...
import com.example.pkt.databinding.FragmentMenuChoiceBinding
...
class MenuChoiceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.readyMealButton.setOnClickListener {
            findNavController().navigate(R.id.action_menuChoiceFragment_to_readyOrderFragment)
        }

        binding.customMealButton.setOnClickListener {
            findNavController().navigate(R.id.action_menuChoiceFragment_to_customOrderFragment)
        }
